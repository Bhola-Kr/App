...
public class FollowersAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface ClickListener { void onItemClick(int position, int id , GetFollowingResponse.Responce mValues);}
    ...
    public FollowersAdapter(Context mCtx , String muserId , String otherUserId , ClickListener mlistener  ) {
        this.context            = mCtx;
        this.userId             = muserId;
...
//      this.mCallback          = (PaginationAdapterCallback) context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ITEM:
                View viewItem = inflater.inflate(R.layout.list_followers, parent, false);
    ...
    private void initLayoutIMAGE(ImagViewHolder holder, int position) {
     ...
     try {
         ...
         Log.e("initLayoutIMAGE", "initLayoutIMAGE: "+ list.get(position).getProfileImage());
         ...
         if (list.get(position).getmFllowing()){
            ...
            holder.tvFollow.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onItemClick(position , holder.tvFollow.getId() , list.get(position));
                }
            });
