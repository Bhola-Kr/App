package com.dreammedia.dreammedia.customWigits.viewPager.edittext;
...
public class RotatableAutofitEditText extends AppCompatEditText {
    ...
    public RotatableAutofitEditText(final Context context, final AttributeSet attrs,
        ...
        if (a != null) {
            minTextSize = a.getDimension(R.styleable.RotatableAutofitEditText_minTextSizee, DEFAULT_MIN_TEXT_SIZE);
            maxTextSize = a.getDimension(R.styleable.RotatableAutofitEditText_maxTextSizee, getTextSize());
