package com.dreammedia.dreammedia.customWigits.viewPager.readMore;
...
public class ReadMoreTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public ReadMoreTextView(Context context, AttributeSet attrs) {
        ...
        this.colorClickableText = typedArray.getColor(R.styleable.ReadMoreTextView_colorClickableText, ContextCompat.getColor(context, R.color.btnColor));
